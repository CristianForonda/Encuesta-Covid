...
window.onload = function() {
    Formio.createForm(document.getElementById('formio'), 'https://suracovid.form.io/encuestavacunacioncovid19auditoria', {
    buttonSettings: {
        showCancel: false,
        showPrevious: false,
        showNext: false,
    ...
    form.on('submit', function(submission) {  
        ...
        $(".progress-text").html("100% completado");      
...
function saveSurvey(submission)
{
    ...
    jsonDataResponse["QID23"] = submission.data.fuisteVacunadoEnIps;    
    if(submission.data.fuisteVacunadoEnIps == 2){
        jsonDataResponse["QID25_TEXT"] = submission.data.dondeFuisteVacunado;
    }   
    ...
    var settings = {
        "url": "https://sjc1.qualtrics.com/API/v3/surveys/SV_dma7VEWO6ZSpduC/responses",
        "method": "POST",
        "timeout": 0,
